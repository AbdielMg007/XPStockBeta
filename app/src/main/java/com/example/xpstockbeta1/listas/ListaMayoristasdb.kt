...
class ListaMayoristasdb(var idCelular: String, var datoRequerido: String) {

    operator fun invoke(): String {
        val idC = idCelular
        val datoR = datoRequerido
        return listaPrecios(idC, datoR)
    }

    public fun listaPrecios(idC: String, datoR: String):String{
